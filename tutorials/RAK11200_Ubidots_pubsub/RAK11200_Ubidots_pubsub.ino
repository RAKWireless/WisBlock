...
const char *UBIDOTS_TOKEN = "BBFF-OzbGAztUJKOPyPMRqM4BHtZMG49QPg";  
const char *WIFI_SSID = "WF Converge_2.4G";    
const char *WIFI_PASS = "Hachimitsu029";      
const char *DEVICE_LABEL = "rak11200";   
const char *VARIABLE_LABEL = "temp"; 
const char *VARIABLE_LABEL_2 = "hum"; 
const char *VARIABLE_LABEL_3 = "press"; 
const char *VARIABLE_LABEL_4 = "gas-res";
const char *SUBSCRIBE_VARIABLE_LABEL = "relay"; 
