...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// Change LoRaWAN credentials to unique device address and key's.
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
/** ABP DevEUI */
uint32_t nodeDevAddr = 0x260116F8; 
/** ABP Network Session Key */
uint8_t nodeNwsKey[16] = {0x2b, 0x84, 0xe0, 0xb0, 0x9b, 0x68, 0xe5, 0xcb, 0x42, 0x17, 0x6f, 0xe7, 0x53, 0xdc, 0xee, 0x79}; // 2b84e0b09b68e5cb42176fe753dcee79
/** ABP Application Session Key */
uint8_t nodeAppsKey[16] = {0x2b, 0x84, 0xe0, 0xb0, 0x9b, 0x68, 0xe5, 0xcb, 0x42, 0x17, 0x6f, 0xe7, 0x53, 0xdc, 0xee, 0x79}; // 2b84e0b09b68e5cb42176fe753dcee79
...
void setup(void)
{
	...
	Serial.println("RAK3312 SX126x LoRaWAN ABP test");
	...
	// Initialize LoRaWan
	err_code = lmh_init(&lora_callbacks, lora_param_init, false, CLASS_A, LORAMAC_REGION_AS923_3);
	if (err_code != 0)
	{
...
/**
 * @brief LoRa function for handling ABP join failed (should never happen)
 *
 */
static void lorawan_join_failed_handler(void)
{
